			...
			<h3 id='title'>HTML lists</h3>
				<center>
					...
					<table id='tablestyle'>
						...
						<td id='d1'>
															<pre>An unordered list starts with the ul tag. Each list item starts with the li tag.
								</pre>
							</td >
						</tr>
						<tr>
						...
						<td id='d2'>
															<pre>starts with the ol tag. Each list item starts with the li tag.
								</pre>
							</td >
						</tr>
						<tr>
						...
						<td id='d4'>
															<pre>A description list is a list of terms, with a description of each term.
								</pre>
							</td >
						</tr>
					</table>
