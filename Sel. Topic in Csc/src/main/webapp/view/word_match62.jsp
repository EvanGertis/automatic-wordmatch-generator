			...
			<h3 id='title'>HTML links</h3>
				<center>
					...
					<table id='tablestyle'>
						...
						<td id='d1'>
															<pre>this tag defines a hyperlink, which is used to link from one page to another
								</pre>
							</td >
						</tr>
						<tr>
