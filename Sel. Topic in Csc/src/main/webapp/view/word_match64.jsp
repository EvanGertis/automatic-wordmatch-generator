			...
			<h3 id='title'>HTML lists</h3>
				<center>
					...
					<table id='tablestyle'>
						...
						<td id='d1'>
															<pre>attribute specifies the link's destination:
								</pre>
							</td >
						</tr>
						<tr>
						...
						<td id='d2'>
															<pre>used to send mail (added to href attribute)
								</pre>
							</td >
						</tr>
						<tr>
						...
						<td id='d3'>
															<pre>starts with the ul tag. Each list item starts with the li tag.
								</pre>
							</td >
						</tr>
						<tr>
						...
						<td id='d4'>
															<pre>An ordered list starts with the ol tag. Each list item starts with the li tag.
								</pre>
							</td >
						</tr>
					</table>
