			...
			<h3 id='title'>HTML typography QUIZ</h3>
				<center>
					<div class='source'>
						...
						<div id='s11' class='draggyBox-small ui-draggable'>
							<p>My favorite color is <del>blue</del> <ins>red</ins>!</p>
						</div>
						<div id='s12' class='draggyBox-small ui-draggable'>
							<br>
						</div>
						<div id='s13' class='draggyBox-small ui-draggable'>
							<hr>
						</div>
					</div>
					</center>
					<table id='tablestyle'>
						...
						<tr>
						<td id='row12'>
							<div id='t12' class='ltarget ui-droppable'></div>
						</td >
						<td id='d12'>
															<pre>Marked text
								</pre>
						...
						<tr>
						<td id='row13'>
							<div id='t13' class='ltarget ui-droppable'></div>
						</td >
						<td id='d13'>
															<pre>Smaller text
								</pre>
